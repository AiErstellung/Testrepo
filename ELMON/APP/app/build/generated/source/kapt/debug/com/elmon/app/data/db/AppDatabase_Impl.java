...
public final class AppDatabase_Impl extends AppDatabase {
  private volatile VideoRatingDao _videoRatingDao;
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(2) {
      ...
      public void dropAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("DROP TABLE IF EXISTS `VideoRating`");
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final TableInfo _existingVideoRating = TableInfo.read(db, "VideoRating");
        if (!_infoVideoRating.equals(_existingVideoRating)) {
          return new RoomOpenHelper.ValidationResult(false, "VideoRating(com.elmon.app.data.model.VideoRating).\n"
                  + " Expected:\n" + _infoVideoRating + "\n"
                  + " Found:\n" + _existingVideoRating);
        }
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "VideoRating");
  }
  ...
  public void clearAllTables() {
    ...
    try {
      ...
      _db.execSQL("DELETE FROM `VideoRating`");
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(VideoRatingDao.class, VideoRatingDao_Impl.getRequiredConverters());
  ...
  @Override
  public VideoRatingDao videoRatingDao() {
    if (_videoRatingDao != null) {
      return _videoRatingDao;
    } else {
      synchronized(this) {
        if(_videoRatingDao == null) {
          _videoRatingDao = new VideoRatingDao_Impl(this);
        }
        return _videoRatingDao;
      }
    }
